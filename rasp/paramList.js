...
/* 5 */ ["",		 "dwcrit",				"Depth of Critical Updraft Strength (AGL Hcrit)", "This is the Height above Ground of the Critical Updraft Strength (qv), i.e. when the updraft strength falls below 225 fpm"],
...
/* 63 */ ["",		 "wind850",		"Wind-850mB", "Wind at pressure level of 850 mB plotted with wind barbs."],

/* 64 */ ["",		 "wind950",		"Wind-950mB", "Wind at pressure level of 850 mB plotted with wind barbs."]
...
var	paramListFull  = [
	...
	paramList[14],
	paramList[15],
	paramList[61],	// NOTE: Out of Order - STARS Rating
	paramList[62],	// NOTE: Out of Order - STARSHG Rating
	paramList[16],
	paramList[17],
	paramList[18],
	paramList[19],
	...
	paramList[22],
	paramList[23],
	paramList[64],	// Out of Order - Wind Barbs
	paramList[63],
	paramList[24],
	paramList[25],
	paramList[26],
